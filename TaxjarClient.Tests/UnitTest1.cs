...
namespace TaxjarClient.Tests
{
    // Currently the unit test has a dependency on a HttpClient instance.
    // This dependency does not make the testing a true unit test.
    // Need to seperate the dependency and mock a HttpClient instance for a true unit test. 
    public class UnitTest1
    {
        ...
        public UnitTest1()
        {
            ...
            taxjarClient = new TaxjarClient(strTaxjarApiKey);
        }
        ...
        public async Task TestGetRateByZipAsync()
        {
            ...
            string strRate = await taxjarClient.GetTaxRateAsync(strZip);
        ...
        public async Task TestGetRateByZipAddressAsync()
        {
            ...
            string strRate = await taxjarClient.GetTaxRateAsync(strZip, address );
        ...
        public async Task TestTaxForOrderAsync()
        {
            ...
            string strTax = await taxjarClient.TaxForOrderAsync(order);  
